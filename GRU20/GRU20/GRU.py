...
def run_optimization(tuning_method='bayes', n_init_points=10, checkpoint_path=None, resume=True):
    ...
    if tuning_method == 'bayes':
        search_space = [
            Categorical([3, 6, 9], name='lookback'),
        ...
        def objective(params):
            ...
            try:
                ...
                # --- CHANGE: Use GRU Wrapper ---
                model_wrapper = GRUWrapper()
...
if __name__ == '__main__':
    ...
    file_path = os.path.join(script_dir, 'Processed_Data_20min.csv')
    ...
    try:
        ...
        tuning_method = 'bayes'
        # --- CHANGE: Directory Name for GRU ---
        dir_name = 'GRU_pm01_optimization20'
